...
PWDEBUG=1 npx playwright test --grep --% "@calculations" --headed --project=chromium


npx playwright test --grep --% "@fast^|@tab2" --headed --project=MobileChrome

npx playwright test --grep --% "@fast^|@tab2" --headed --project=MobileSafari
